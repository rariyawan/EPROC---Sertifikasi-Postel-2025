  ...
  <tr>
    <td>
        ...
        <tr>
          ...
          <td class="add_tab-active"><b>Postel Certificate Request Data</b></td> 
    ...
    <asp:Panel ID="pnlForm" runat="server">
      ...
      <tr>
          <td>
            ...
            <table class="add_table-form"><caption style="display:none">Data</caption><tr style="display:none"><th></th></tr>
                <tr class="Controls">
                   <td colspan="2" style="background-color:lightblue; text-align:center; width: 50%"><strong>CERTIFICATE DATA PREVIOUS</strong></td>
